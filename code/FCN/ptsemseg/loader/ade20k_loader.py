...
class ADE20KLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        lbl_path = self.root + "annotations/" + self.split
        if self.split == "training" :
            lbl_path = lbl_path + "/ADE_train_" + img_name + ".png"
        else :
            lbl_path = lbl_path + "/ADE_val_" + img_name + ".png"
...
if __name__ == "__main__":
    local_path = "/home/jz3350/deeplearning/project/ADEChallengeData2016/"
